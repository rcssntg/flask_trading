    ...
    if request.method == 'POST':
        ...
        if p_item_object:
            if current_user.can_purchase(p_item_object):
                ...
                flash(f'Unfortunately, you only have ${current_user.budget} in your wallet and it is not enough to purchase {p_item_object.name} which is ${p_item_object.price}.', category='danger')
        # Sell item Logic
